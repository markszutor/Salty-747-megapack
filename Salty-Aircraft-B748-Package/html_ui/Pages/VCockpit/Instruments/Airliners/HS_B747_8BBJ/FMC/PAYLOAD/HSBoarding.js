class SaltyBoarding {
    ...
    async update(_deltaTime) {
        ...
        if (
            (!HSBoarding.airplaneCanBoard() && boardingRate == "REAL") ||
            (!HSBoarding.airplaneCanBoard() && boardingRate == "FAST") ||
